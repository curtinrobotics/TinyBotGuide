...
Something important to note from the pinout in Figure \ref{fig:l293d-pinout} is the pins labelled enable 1 and enable 2. These pins need to be set to a positive voltage for the motor to be enabled. 
\bigskip
