...
\author{\small contact@curtinrobotics.org} % Your name
...
% This document was created by the Curtin Robotics Club, and has been provided for free use.  
...
% \begin{sidewaystable}[h]
    \begin{xltabular}{\linewidth}{p{0.15\textwidth} p{0.05\textwidth} p{0.1\textwidth} X}
        ...
        Geared DC Motor & 2 & \$5 - \$20 & The motors used in this guide are N20 motors (small and strong), however any \textbf{geared} DC motor can be use (such as \href{https://www.jaycar.com.au/dc-geared-motor-with-rubber-wheel/p/YG2900}{these}). There are 2 main ways to source N20 motors: \begin{itemize}
        ...
        Core Flute / Cardboard & - & - & The base of TinyBot can be built out of any material you have on hard given it is stiff enough to support the components. Materials such as core flute, cardboard, wood, plastic, etc. are perfect.\\[2cm]
